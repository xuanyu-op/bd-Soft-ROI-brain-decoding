...
class Perceiver(nn.Module):
    """
    Normalize, resample, and linearly project input token features into a fixed number of tokens with the target hidden dimension.
    """
...
class BrainEncoder(nn.Module):
    """
    Extract image features using a frozen CLIP Vision model and return the patch token representations from the second-to-last hidden layer.
    """
