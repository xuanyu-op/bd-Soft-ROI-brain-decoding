...
def build_dataloaders(args, accelerator, num_devices, num_workers):
    """
    Build training and validation dataloaders for multiple subjects, and return the corresponding sample count information.
    """
    train_dls = {}
    val_dls = {}
    num_train_samples = {}
    ...
    for subj in args.subjects:
        ...
        # Construct the validation set path
        ...
        # Call the general-purpose dataloader builder in utils to create the training and validation dataloaders for the current subject
